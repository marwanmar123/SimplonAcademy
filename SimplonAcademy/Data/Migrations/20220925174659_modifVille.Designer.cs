...
namespace SimplonAcademy.Data.Migrations
{
    ...
    [Migration("20220925174659_modifVille")]
    partial class modifVille
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimplonAcademy.Models.Formation", b =>
                {
                    ...
                    b.HasIndex("FormationTypeId")
                        .IsUnique()
                        .HasFilter("[FormationTypeId] IS NOT NULL");
            ...
            modelBuilder.Entity("SimplonAcademy.Models.InscriptionForm", b =>
                {
                    ...
                    b.HasIndex("FormationId")
                        .IsUnique()
                        .HasFilter("[FormationId] IS NOT NULL");
            ...
            modelBuilder.Entity("SimplonAcademy.Models.Formation", b =>
                {
                    b.HasOne("SimplonAcademy.Models.FormationType", "FormationType")
                        .WithOne("Formation")
                        .HasForeignKey("SimplonAcademy.Models.Formation", "FormationTypeId");
            ...
            modelBuilder.Entity("SimplonAcademy.Models.InscriptionForm", b =>
                {
                    b.HasOne("SimplonAcademy.Models.Formation", "Formation")
                        .WithOne("InscriptionForm")
                        .HasForeignKey("SimplonAcademy.Models.InscriptionForm", "FormationId");
            ...
            modelBuilder.Entity("SimplonAcademy.Models.Ville", b =>
                {
                    b.HasOne("SimplonAcademy.Models.Formation", null)
                        .WithMany("Ville")
